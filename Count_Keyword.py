...
#-----------------------------------
keyword_counts =  csv.writer(open("keyword_count.csv", "wb"))


#Get list of terms from text file
#--------------------------------
FILE	= open('E:\Dropbox\HiphopFiles\Python Script\Counts Program/kbbcars.txt', 'r')
...
for track in tracks:
    ...
    for term in terms:
        for line in lines:
            ...
            matches = re.findall('\\b'+term+'[e]*[s]*\\b',line, re.IGNORECASE)
            if term in counts:
